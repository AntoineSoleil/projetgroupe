    	...
    	<div class="row container">
    		<table class="table table-bordered">
			    <TR>
			    	...
			    	<TD><?php echo $cra->satisfaction_consultant ?></TD>
			    </TR>
			    <TR>
			    	<TD><b>Satisfaction du Client</b></TD>
			    	<TD><?php echo $cra->satisfaction_client ?></TD>
			    </TR>
			    <TR>
			    	<TD><b>Points d'amélioration</b></TD>
			    	<TD><?php echo $cra->ameliorations ?></TD>
			    </TR>
			    <TR>
			    	<TD><b>Actions restantes à effectuer</b></TD>
			    	<TD><?php echo $cra->actions_restantes ?></TD>
			    </TR>
			    <TR>
			    	<TD><b>Commentaire</b></TD>
			    	<TD><?php echo $cra->commentaires ?></TD>
			    </TR>
			</table>
    	</div>
